...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeTestBundle', '/var/www/Symfony/app/Resources/AcmeTestBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeTestBundle', '/var/www/Symfony/src/Acme/TestBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeMsgBundle', '/var/www/Symfony/app/Resources/AcmeMsgBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeMsgBundle', '/var/www/Symfony/src/Acme/MsgBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeMsgbBundle', '/var/www/Symfony/app/Resources/AcmeMsgbBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeMsgbBundle', '/var/www/Symfony/src/Acme/MsgbBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => '/var/www/Symfony/src/Acme/TestBundle/Resources/config/doctrine', 1 => '/var/www/Symfony/src/Acme/MsgBundle/Resources/config/doctrine', 2 => '/var/www/Symfony/src/Acme/MsgbBundle/Resources/config/doctrine'));
        $d->setNamespacePrefixes(array('/var/www/Symfony/src/Acme/TestBundle/Resources/config/doctrine' => 'Acme\\TestBundle\\Entity', '/var/www/Symfony/src/Acme/MsgBundle/Resources/config/doctrine' => 'Acme\\MsgBundle\\Entity', '/var/www/Symfony/src/Acme/MsgbBundle/Resources/config/doctrine' => 'Acme\\MsgbBundle\\Entity'));
        $d->setGlobalBasename('mapping');
        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Acme\\TestBundle\\Entity');
        $e->addDriver($d, 'Acme\\MsgBundle\\Entity');
        $e->addDriver($d, 'Acme\\MsgbBundle\\Entity');
        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AcmeTestBundle' => 'Acme\\TestBundle\\Entity', 'AcmeMsgBundle' => 'Acme\\MsgBundle\\Entity', 'AcmeMsgbBundle' => 'Acme\\MsgbBundle\\Entity'));
    ...
    {
        return $this->services['pdo'] = new \PDO('mysql:dbname=symfony', 'root', 'root');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/Symfony/vendor/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/var/www/Symfony/src/Acme/MsgbBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeMsgBundle' => 'Acme\\MsgBundle\\AcmeMsgBundle',
                'AcmeMsgbBundle' => 'Acme\\MsgbBundle\\AcmeMsgbBundle',
            ),
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/var/www/Symfony/src/Acme/MsgbBundle/Resources/config/validation.yml',
            ),
